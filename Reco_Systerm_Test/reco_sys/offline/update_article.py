...
from pyspark.ml.feature import  Word2VecModel,BucketedRandomProjectionLSH
...
3-计算tf-idf
4-textrank的计算
5-artcle_profile=keywords,topic
'''
# 分词
...
#     ua = UpdateArticle()
#     sentence_df = ua.merge_article_data()#合并后的sentence字段
#     if sentence_df.rdd.collect():
#         #计算tfidf和textrank--textrank_keywords_df, keywordsIndex
#         rank, idf = ua.generate_article_label(sentence_df)
#         #计算用户画像的topic和keywords
